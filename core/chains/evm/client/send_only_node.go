...
//
// Deprecated: use [pkg/github.com/DeAI-Artist/MintAI/common/client.SendOnlyNode]
...
//
// Deprecated: use [pkg/github.com/DeAI-Artist/MintAI/common/client.NewSendOnlyNode]
