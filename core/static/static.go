...
func SetConsumerName(uri *url.URL, name string, id *uuid.UUID) {
	...
	applicationName := fmt.Sprintf("MAI%s|%s", buildPrettyVersion(), name)
	if id != nil {
