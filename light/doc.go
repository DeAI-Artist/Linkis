...
https://github.com/DeAI-Artist/MintAI/blob/v0.34.x/spec/consensus/light-client/verification.md
for details.
...
for usage example.
Or see
https://github.com/DeAI-Artist/MintAI/tree/v0.34.x/spec/consensus/light-client
for the full spec
*/
package light
