...
information can be found in either [data structures](https://github.com/DeAI-Artist/MintAI/blob/v0.34.x/spec/core/data_structures.md)
or [accountability](https://github.com/DeAI-Artist/MintAI/blob/v0.34.x/spec/light-client/accountability/)
