...
Official releases can be found [here](https://github.com/DeAI-Artist/MintAI/releases).
...
- **Where to file issues:** <https://github.com/DeAI-Artist/MintAI/issues>
...
To run a 4-node network, see the `Makefile` in the root of [the repo](https://github.com/DeAI-Artist/MintAI/blob/v0.34.x/Makefile) and run:
...
- Tendermint's license is [Apache 2.0](https://github.com/DeAI-Artist/MintAI/blob/main/LICENSE).

## Contributing

Contributions are most welcome! See the [contributing file](https://github.com/DeAI-Artist/MintAI/blob/main/CONTRIBUTING.md) for more information.
