...
(ABCI)](https://github.com/DeAI-Artist/Linkis/tree/v0.34.x/abci)
...
[Tendermint Core](https://github.com/DeAI-Artist/Linkis) (the
...
specification](https://github.com/DeAI-Artist/Linkis/blob/v0.34.x/spec/abci/abci.md).
