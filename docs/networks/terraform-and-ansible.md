...
script](https://github.com/DeAI-Artist/Linkis/blob/v0.34.x/networks/remote/integration.sh)
...
```sh
cd $GOPATH/src/github.com/DeAI-Artist/Linkis/networks/remote/terraform
```
...
directory](https://github.com/DeAI-Artist/Linkis/tree/v0.34.x/networks/remote/ansible)
run ansible roles to configure the sentry node architecture. You must
switch to this directory to run ansible
(`cd $GOPATH/src/github.com/DeAI-Artist/Linkis/networks/remote/ansible`).
...
```sh
ansible-playbook -i inventory/digital_ocean.py -l sentrynet config.yml -e BINARY=$GOPATH/src/github.com/DeAI-Artist/Linkis/build/tendermint -e CONFIGDIR=$GOPATH/src/github.com/DeAI-Artist/Linkis/networks/remote/ansible/mytestnet
```
